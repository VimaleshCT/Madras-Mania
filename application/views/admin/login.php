...
<head>
    ...
    <title>Madras Mania - Login</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <a href="<?php echo base_url(); ?>">
                                    <!-- Madras Mania Logo -->
                                    <img src="<?php echo base_url(); ?>assets/img/Madras Mania Logo.png"
                                        alt="Madras Mania Logo" style="height:100px;width:100px;">
                                </a>
                            </div>
                            ...
                            <!-- Sign In Form -->
                            <h3 class="text-center mb-4 font-w600">Sign In to Madras Mania</h3>
