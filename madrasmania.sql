...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2024 at 07:39 AM
...
INSERT INTO `products` (`id`, `product_name`, `description`, `product_image`, `price`, `category_id`, `todayspecial`, `topseller`, `status`, `veg non-veg`, `category_name`) VALUES
(1, 'Kozhi Malli Saaru ', 'Eine würzige südindische Hühnersuppe mit frischem Koriander und aromatischen Gewürzen', '1.jpg', '4.9', 1, 0, 0, 1, 1, 'Suppe'),
(2, 'Tomato Rasam ', 'Eine pikante südindische Tomatensuppe aromatischen Gewürzen.', '2.jpg', '4.49', 1, 0, 0, 1, 0, 'Suppe'),
(3, 'Medhu Vada', 'Weiche, knusprige Linsen-Donuts, frittiert und perfekt gewürzt', '3.jpg', '5.99', 2, 0, 0, 1, 0, 'Südindische Vorspeisen-veg'),
(4, 'Milagai / Onion / Vazhakkai Bread Bajji', 'Tiefgebackene Fritters aus ausgewählten Gemüsesorten, umhüllt von gewürztem Linsen-Teig', '4.jpg', '5.99', 2, 0, 0, 1, 0, 'Südindische Vorspeisen-veg'),
(5, 'Tea Kadai Samosa', 'Knuspriger, frittierter Snack aus hausgemachten Samosa-Teigblättern, gefüllt mit würziger Zwiebel-Füllung', '5.jpg', '5.99', 2, 0, 0, 1, 0, 'Südindische Vorspeisen-veg'),
(6, 'Marina Beach Sundal', 'Knuspriger, frittierter Snack aus hausgemachten Samosa-Teigblättern, gefüllt mit würziger Zwiebel-Füllung', '6.jpg', '4.99', 2, 0, 0, 1, 0, 'Südindische Vorspeisen-veg'),
...
(8, 'Sambar Vada (2 Nos)', 'Frittierter Linsendonut in köstlichen Sambar, garniert mit Zwiebeln und Koriander ', '8.jpg', '5.99', 2, 0, 0, 1, 0, 'Südindische Vorspeisen-veg'),
(9, 'Mysore Bonda (2 Nos)', 'Knusprige Linsenkugeln mit Chutney und Sambar', '9.jpg', '5.99', 2, 0, 0, 1, 0, 'Südindische Vorspeisen-veg'),
(10, 'Curd Vada (2 Nos)', 'Linsendonut in Joghurt, garniert mit Karotten, Koriander, Chilipulver & knusprigen Streuseln', '10.jpg', '5.99', 2, 0, 0, 1, 0, 'Südindische Vorspeisen-veg'),
...
(12, 'Egg Podimas', 'Linsendonut in Joghurt, garniert mit Karotten, Koriander, Chilipulver & knusprigen Streuseln', '12.jpg', '7', 3, 0, 0, 1, 1, 'Südindische Vorspeisen (non-veg)'),
...
(14, 'Madurai Mutton Chuka', 'Knochenlose zarte Stücke von Lammfleisch, mariniert in handgemachten Gewürzmischungen des Kochs, mit Cashewnüssen geröstet', '14.jpg', '14', 3, 0, 0, 1, 1, 'Südindische Vorspeisen (non-veg)'),
...
(16, 'Plain Dosa ', 'Dünner knuspriger Reis-Linsen-Crêpe', '16.jpg', '7', 4, 0, 0, 1, 0, 'Dosa Welt'),
(17, 'Rava Dosa ', ' Dünner & knuspriger Crêpe aus Grieß & Reis mild gewürzt & garniert', '17.jpg', '8.5', 4, 0, 0, 1, 0, 'Dosa Welt'),
(18, 'Madras Masala Dosa', 'Reis-Linsen-Crêpe, gefüllt mit Kartoffelpüree und Zwiebeln', '18.jpg', '8.99', 4, 0, 0, 1, 0, 'Dosa Welt '),
(19, 'Mysore Masala Dosa', 'Rotes Chili-Chutney auf dünnem Reis-Linsen-Crêpe, gefüllt mit Kartoffelpüree und Zwiebeln', '19.jpg', '8.99', 4, 0, 0, 1, 0, 'Dosa Welt '),
...
(21, 'Paneer Dosa', 'Dünner Reiscrêpe gefüllt mit Hüttenkäse', '21.jpg', '9.99', 4, 0, 0, 1, 0, 'Dosa Welt '),
(22, 'Onion Dosa ', 'Dünner, knuspriger Reis-Linsen-Crêpe mit Zwiebeln', '22.jpg', '7.99', 4, 0, 0, 1, 0, 'Dosa Welt '),
(23, 'Ghee Roast', 'Dünner, langer Reis-Linsen-Crêpe, bestreut mit Desi Ghee', '23.jpg', '8.5', 4, 0, 0, 1, 0, 'Dosa Welt '),
(24, 'Onion Rava Dosa ', 'Dünner, knuspriger Reis-Linsen-Crêpe mit Zwiebeln', '24.jpg', '8.99', 4, 0, 0, 1, 0, 'Dosa Welt '),
(25, 'Onion Rava Masala dosa ', 'Dünner Crêpe aus Grieß & Reis bestreut mit Zwiebeln\n', '25.jpg', '9.99', 4, 0, 0, 1, 0, 'Dosa Welt'),
...
(32, 'Idly (3 Nos)', 'Zermahlener gedämpfte, flach-runde Küchlein aus einem fermentierten Teig auf Basis von Urdbohnen und Reis.', '32.jpg', '7', 5, 0, 0, 1, 0, 'Idly Welt'),
(33, 'Chilli Idly', 'Gedünstete Reisküchlein gehackt, leicht angebraten und mit würziger Chilisauce verfeinert.', '33.jpg', '9', 5, 0, 0, 1, 0, 'Idly Welt'),
(34, 'Idly Vada', 'Gedünsteter Reis- und Linsendonut, serviert mit Chutney und Sambar', '34.jpg', '8', 5, 0, 0, 1, 0, 'Idly Welt '),
(35, 'Thatte Idly (Karnataka Style)', 'Große, flache Donuts aus einem Teig aus Reis und Linsen, traditionell gedämpft und mit verschiedenen Chutneys und Sambar serviert', '35.jpg', '7.5', 5, 0, 0, 1, 0, 'Idly Welt '),
(36, 'Mini Sambar Idly', 'Mini-Müßiggang köchelte im köstlichen Süden Indische Linsensoße, garniert mit Ghee', '36.jpg', '7', 5, 0, 0, 1, 0, 'Idly Welt '),
(37, 'Parotta & Salna', 'Köstliches südindisches luftiges Brot serviert mit Kartoffelpüree und Salna (Curry Soße)', '37.jpg', '8', 6, 0, 0, 1, 0, 'Parotta Vilas'),
...
(42, 'Tomato Onion Uthappam', 'Gegrillter Paneer in einer würzigen Joghurt-KnoblauchMarinade ', '42.jpg', '9', 7, 0, 0, 1, 0, 'Uthappam'),
...
(44, 'Mango achari Paneer Tikka', 'Brokkoli in einer üppigen Marinade aus abgetropftem Joghurt und Malai, gewürzt mit erlesenen Gewürzen', '44.jpg', '13.99', 8, 0, 0, 1, 0, 'Tandoori Vorspeisen (veg)'),
...
(46, 'Veg Kebab Platter', 'Mariniertes Hackfleisch mit braunen Zwiebeln und Käse, umhüllt von gehackten Zwiebeln und Paprika.', '46.jpg', '22', 8, 0, 0, 1, 0, 'Tandoori Vorspeisen (veg)'),
(47, 'Jalandhari Mutton Seekh', 'Pomfret fisch mariniert in würzigen Tandoori-Gewürzen und perfekt gegrillt', '47.jpg', '19.5', 9, 1, 0, 1, 1, 'Tandoori Vorspeisen(non-veg)'),
