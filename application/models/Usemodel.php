...
class Usemodel extends CI_Model
{
    ...
    {
        // Fetch products along with their category icons, allergens, and allergen icons
        $this->db->select('category_name, product_name, price, description, product_image, veg_non_veg, allergens, allergen_icons, cat_icon');
        ...
        foreach ($products as $product) {
            ...
            $slug = url_title($product['category_name'], 'dash', true);
            $product['slug'] = $slug; // Add slug to each product
            $categories_with_products[$product['category_name']][] = $product; // Group products by category name
        }
